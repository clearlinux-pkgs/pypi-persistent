...
Version  : 6.0
Release  : 83
URL      : https://files.pythonhosted.org/packages/d9/d8/312266a4a6db85fb149c7b95b6252e59f311dace9b38298bb8b4228ffb31/persistent-6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/d9/d8/312266a4a6db85fb149c7b95b6252e59f311dace9b38298bb8b4228ffb31/persistent-6.0.tar.gz
...
BuildRequires : pypi(zope.deferredimport)
...
%prep
%setup -q -n persistent-6.0
cd %{_builddir}/persistent-6.0
pushd ..
cp -a persistent-6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717080263
